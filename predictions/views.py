...
def dashboard(request):
    try:
        ...
        return render(request, 'predictions/dashboard.html', {'error': str(e)})
...
def shipment_prediction(request):
    if request.method == 'POST':
        ...
        try:
            predictor = mindsdb.get_predictor('shipment_delay_predictor')
        except Exception as e:
            return render(request, 'predictions/shipment_result.html', {'error': 'Predictor not found'})
        ...
        try:
            ...
            return render(request, 'predictions/shipment_result.html', {'error': str(e)})

        context = {
            'predicted_arrival_date': predicted_arrival_date,
        }
        return render(request, 'predictions/shipment_result.html', context)

    return render(request, 'predictions/shipment_form.html')
...
def demand_forecasting(request):
    if request.method == 'POST':
        ...
        try:
            ...
            return render(request, 'predictions/demand_result.html', {'error': str(e)})

        context = {
            'predicted_sales': predicted_sales,
        }
        return render(request, 'predictions/demand_result.html', context)

    return render(request, 'predictions/demand_form.html')
...
def inventory_optimization(request):
    try:
        ...
        return render(request, 'predictions/inventory_optimization.html', context)
    except Exception as e:
        return render(request, 'predictions/inventory_optimization.html', {'error': str(e)})
